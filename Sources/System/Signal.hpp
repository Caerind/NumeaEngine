...
#ifndef NU_SIGNAL_HPP
#define NU_SIGNAL_HPP
...
#define NuDetailSignal(Keyword, SignalName, ...) using SignalName ## Type = nu::Signal<__VA_ARGS__>; Keyword SignalName ## Type SignalName

#define NuSignal(SignalName, ...) NuDetailSignal(mutable, SignalName, __VA_ARGS__)
#define NuStaticSignal(SignalName, ...) NuDetailSignal(static, SignalName, __VA_ARGS__)
#define NuStaticSignalImpl(Class, SignalName) Class :: SignalName ## Type Class :: SignalName

#define NuSlot(Class, SignalName, SlotName) Class::SignalName ## Type::ConnectionGuard SlotName
